import { Box, CircleDashed, CircleSlash2, Star, Triangle } from "lucide-react";

export default function Page() {
  return (
    <div className="flex size-full flex-col items-center justify-center">
      <div className="flex size-[150px] items-center justify-center ">
        <Box className=" peer absolute z-50  size-[50px] animate-spin text-amber-500 hover:text-foreground dark:text-amber-300" />
