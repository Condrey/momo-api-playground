...
import { Home, CircleDashed, Star, Triangle, CircleSlash2, Box, DoorOpen, Code, Code2 } from "lucide-react";
...
export default function NewComer() {
  return (
    ...
    <div className="flex size-[150px] items-center justify-center ">
        <Code2 className=" peer absolute z-50  size-[50px] hover:animate-spin text-amber-500  hover:text-foreground dark:text-amber-300" />
      ...
      <span className=" text-2xl font-bold">WeLCoMe DeV BuDdY</span>
      <span>Sign in to continue testing out these cool resources.</span>
